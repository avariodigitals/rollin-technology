// TARGET PATH IN REPO: src/app/(account)/account/addresses/page.tsx — REPLACE THE ENTIRE FILE
"use client"
...
import { GET_CURRENT_CUSTOMER } from "@/lib/queries"
...
export default function AddressesPage() {
  ...
  useEffect(() => {
    if (!authToken) return
    fetchGraphQL(GET_CURRENT_CUSTOMER, {}, authToken).then((data) => {
